        ...
        <div className="row">
          ...
          >
            <div className="card-body">
              ...
              <p class="card-text">
                <small class="text-muted">💰Avarage fees: 60,000 to INR 1 LPA</small>
              </p>
              <p class="card-text">
          ...
          >
            <div className="card-body">
              ...
              <p class="card-text">
                <small class="text-muted">💰Avarage fees: 10,000 - 2 LPA</small>
              </p>
              <p class="card-text">
                <small class="text-muted">⌛Duration: 3 Years</small>
              </p>
          ...
          >
            <div className="card-body">
              ...
              <p class="card-text">
                <small class="text-muted">💰Avarage fees: 1 to 8 LPA
</small>
              </p>
              <p class="card-text">
